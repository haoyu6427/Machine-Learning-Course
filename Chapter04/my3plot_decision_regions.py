...
def myplot_decision_regions(X, y, classifier, test_idx=None, resolution=0.02):
    ...
    svm = SVC(kernel = classifier.kernel, C=1.0, random_state=1)
    svm.fit(X_train_std, y_train)
    
    plot_decision_regions(X_combined_std, y_combined, clf=svm, legend=2)
